...
<div className="relative w-full h-full  lg:h-full lg:w-1/2 justify-center bg-[#0099D7] lg:items-center">
    <Onboard/>
  </div>
  <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
      <div className="border-solid border border-gray rounded-lg py-6">
          <div className="mx-auto max-w-lg text-center">
          <h1 className="text-2xl font-bold sm:text-3xl">Welcome back to SenexCare</h1>
